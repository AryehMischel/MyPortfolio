...
camera.position.set(0.005, 1.6, 0); // Adjust the camera position 0.005, 1.6, 0.5
// camera.lookAt(0, 1.6, 0); // Look at the origin
...
// hdriLoader.load('./MR_INT-002_BathroomHard_Pierre.hdr', function (texture) {
//   texture.mapping = THREE.EquirectangularReflectionMapping;
//   scene.environment = texture;
//   // scene.background = texture; // Optional: set the background to the HDRI
// });

const hdriLoader = new UltraHDRLoader();
hdriLoader.setDataType( THREE.FloatType );

const loadEnvironment = function ( resolution = '2k', type = 'HalfFloatType' ) {
  hdriLoader.setDataType( THREE[ type ] );

  hdriLoader.load( `./san_giuseppe_bridge_2k.jpg`, function ( texture ) {
